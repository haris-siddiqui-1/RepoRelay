    ...
    "attachments": [
        {
            ...
            "content": {
                ...
                "body": [
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "items": [
                                    ...
                                    {
                                        "type": "TextBlock",
                                        "text": "P2 {% trans 'Priority Finding' %}",
                                        "weight": "Bolder",
                                        "size": "Large",
                                        "color": "Warning"
                                    }
                    ...
                    {
                        "type": "TextBlock",
                        "text": "{% blocktranslate with title=finding.title %}P2 priority finding [{{ title }}]({{ finding_url|full_url }}) should be reviewed and triaged.{% endblocktranslate %}",
                        "wrap": true,
                        "spacing": "Medium"
                    },
                    {
