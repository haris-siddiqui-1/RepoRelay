    ...
    "attachments": [
        {
            ...
            "content": {
                ...
                "body": [
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "items": [
                                    ...
                                    {
                                        "type": "TextBlock",
                                        "text": "{% trans 'Weekly P4 Findings Digest' %}",
                                        "weight": "Bolder",
                                        "size": "Large",
                                        "color": "Accent"
                                    }
                    ...
                    {
                        "type": "TextBlock",
                        "text": "{% blocktranslate with count=findings|length %}{{ count }} P4 (Minimal Priority) finding(s) were identified this week.{% endblocktranslate %}",
                        "wrap": true,
                        "spacing": "Medium"
                    },
                    {
                        "type": "TextBlock",
                        "text": "{% trans 'P4 findings are informational and typically require no immediate action.' %}",
                        "wrap": true,
                        "spacing": "Small",
                        "isSubtle": true
                    },
